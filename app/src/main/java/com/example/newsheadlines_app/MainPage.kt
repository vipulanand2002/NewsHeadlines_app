            ...
            NewsHeadlines_appTheme() {
                ...
                Surface(color = MaterialTheme.colors.background) {
                    Column() {
                        ...
                        Text(text = "Latest India NEWS!!", fontSize = 32.sp, modifier = Modifier.fillMaxWidth(), textAlign = TextAlign.Center)
    ...
    Card(
        modifier = Modifier
            ...
            .selectable(true, true, null,
                onClick = {
                    Log.i("123abc", "MovieItem: $index/n$selectedIndex")
                })
            .clickable { onClick(index) }
            .height(180.dp), shape = CutCornerShape(8.dp), elevation = 4.dp
    ) {
            ...
            )
            {
                ...
                Column(
                    ...
                    modifier = Modifier
                        ...
                        .selectable(true, true, null,
                            onClick = {
                                Log.i("123abc", "MovieItem: $index/n${movie.description}")
                                context.startActivity(
                                    Intent(context, DisplayNews::class.java)
                                        .setFlags(Intent.FLAG_ACTIVITY_NEW_TASK)
                                        .putExtra("desc", movie.description.toString())
